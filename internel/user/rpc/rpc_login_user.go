...
func (server *Server) LoginUser(
	...
	session, err := server.store.CreateSession(ctx, &userrepo.CreateSessionParams{
	...
	rsp := &vulcanv1.LoginUserResponse{
...
func validateLoginUserRequest(req *vulcanv1.LoginUserRequest) (violations []*errdetails.BadRequest_FieldViolation) {
